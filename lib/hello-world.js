...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            else if (actionType == basePath_1.TURN_ON_FEATURE_FLAG) {
                let selectedFeatureFlag = yield getFeatureFlag(projectId);
                yield FeatureFlag_1.FeatureFlagsAPI.setFeatureFlagState(selectedFeatureFlag, projectId, "on");
            }
            else {
                let selectedFeatureFlag = yield getFeatureFlag(projectId);
